...
public class DeploymentInstallOptionsImpl extends DeploymentOptionsImpl implements DeploymentInstallOptions {
    
    private Boolean systemUpdate = false;
    private String  verifierURI  = null;

    // Metrics in RESOURCE_INSTALL
    public DeploymentInstallOptionsImpl(String dpName, String dpVersion) {
        super(dpName, dpVersion);
    }

    public DeploymentInstallOptionsImpl(KuraPayload request) throws KuraException {
