...
public enum SupportedUsbModemInfo {
	...
	Telit_HE910_DG  ("HE910-DG",   "1bc7", "0021", 6, 0, 3, 0, 4,  Arrays.asList(ModemTechnologyType.HSPA, ModemTechnologyType.UMTS), Arrays.asList(new UsbModemDriver("cdc_acm", "1bc7", "0021")), "6 CDC-ACM"),
